...
void CAN_vInit(void)
{
  ...
  ///  Allocate MOs for list 1:
    ...
    CAN_vSetListCommand(0x01020002);  // MO2 for list 1
  ...
  ///  - identifier 29-bit:      0x000201FE

  //--------------MOAR0 = 0xE00201FE---------------------------------------

    CAN_vWriteAMData(0xE00201FE); // load MO0 arbitration register
  ...
  ///  - acceptance mask 29-bit: 0x003FFFFF

  //--------------CAN_MOAMR0 = 0x203FFFFF------------------------------------

    CAN_vWriteAMData(0x203FFFFF); // load MO0 acceptance mask register
  ...
  ///    order (like class 1)
  ///  - extended 29-bit identifier
  ///  - identifier 29-bit:      0x003FFE01

  //--------------MOAR1 = 0xE03FFE01---------------------------------------

    CAN_vWriteAMData(0xE03FFE01); // load MO1 arbitration register
  ...
  //--------------CAN_MOAMR1 = 0x203FFFFF------------------------------------

    CAN_vWriteAMData(0x203FFFFF); // load MO1 acceptance mask register
  ...
  //--------------MOCTR2 = 0x00A00000---------------------------------------
    ...
    CAN_vWriteAMData(0x00A00000); // load MO2 control register
  ...
  ///    order (like class 1)
  ///  - extended 29-bit identifier
  ///  - identifier 29-bit:      0x003FFEFF

  //--------------MOAR2 = 0xE03FFEFF---------------------------------------

    CAN_vWriteAMData(0xE03FFEFF); // load MO2 arbitration register
  ...
  //--------------CAN_MOAMR2 = 0x203FFFFF------------------------------------

    CAN_vWriteAMData(0x203FFFFF); // load MO2 acceptance mask register
  ...
  //--------------MOIPR2 = 0x00000221---------------------------------------
    ...
    CAN_vWriteAMData(0x00000221); // load MO2 interrupt pointer register
  ...
  //--------------MOFCR2 = 0x08010000---------------------------------------
    ...
    CAN_vWriteAMData(0x08010000); // load MO2  function control register
